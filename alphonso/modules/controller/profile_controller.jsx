     ...
     <img
        ...
        className="flex flex-col pt-3  items-center">
         ...
         <CreatorTag/>
          ...
          <small className="text-sm pt-3 text-primary-300">Joined on {moment(profile?.insertedAt).format("LL")}</small>
        </div>
     </div>
    {
